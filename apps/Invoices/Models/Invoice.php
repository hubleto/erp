...
class Invoice extends \Hubleto\Erp\Model {
  ...
  public function describeColumns(): array
  {
    return array_merge(parent::describeColumns(), [
      ...
      'description_before' => (new Varchar($this, $this->translate('Description before the list of items'))),
      'description_after' => (new Varchar($this, $this->translate('Description after the list of items'))),
