...
class Activity extends \Hubleto\Erp\Model
{
  ...
  public array $relations = [
    'WORKER' => [ self::BELONGS_TO, \Hubleto\Framework\Models\User::class, 'id_worker', 'id' ],
  ...
  public function describeColumns(): array
  {
    return array_merge(parent::describeColumns(), [
      'id_worker' => (new Lookup($this, $this->translate('Worker'), \Hubleto\Framework\Models\User::class))->setReactComponent('InputUserSelect')->setProperty('defaultVisibility', true)->setDefaultValue($this->getService(\Hubleto\Framework\AuthProvider::class)->getUserId())->setRequired(),
