...
export default class FormEntry<P, S> extends HubletoForm<FormEntryProps, FormEntryState> {
  static defaultProps: any = {
    ...
    model: "Hubleto/App/Community/BkJournal/Models/Entry"
  };
  ...
  translationContext: string = 'Hubleto\\App\\Community\\BkJournal\\Loader::Components\\FormEntry';
    ...
    return <>
      ...
      { R.id > 0 &&
        ...
        <div className="card mt-4">
          <div className="card-body">
            <Table model="Hubleto/App/Community/BkJournal/Models/EntryLine" formProps={{
              model: 'Hubleto/App/Community/BkJournal/Models/EntryLine',
