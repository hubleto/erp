...
interface TableShopsProps extends HubletoTableProps { }

interface TableShopsState extends HubletoTableState { }

export default class TableShops extends HubletoTable<TableShopsProps, TableShopsState> {
  static defaultProps = {
