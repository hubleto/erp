...
import FormEntry from "@hubleto/apps/BkJournal/Components/FormEntry";
...
export default class TableEntries extends Table<TableEntriesProps, TableEntriesState> {
  ...
  translationContext: string = 'Hubleto\\App\\Community\\BkJournal\\Loader::Components\\TableEntries';
