...
import TableDeals from "../../../Sales/Deals/Components/TableDeals";
import FormDeal, {FormDealProps, FormDealState} from "../../../Sales/Deals/Components/FormDeal";
              ...
              <TableLeads
                ...
                description={{
                  ...
                  columns: {
                    ...
                    id_currency: { type: "lookup", title: "Amount", model: 'CeremonyCrmMod/Core/Settings/Models/Currency' },
