...
class Loader extends \HubletoMain\Core\App
{
  ...
  public function installTables(int $round): void
  {
    ...
    $mPipeline->record->recordCreate([ "name" => "Default pipeline" ]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Prospecting', 'order' => 1, 'color' => '#4080A0', 'id_pipeline' => 1 , "set_result" => Deal::RESULT_PENDING, "probability" => 1]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Qualified to buy', 'order' => 2, 'color' => '#A04020', 'id_pipeline' => 1, "set_result" => Deal::RESULT_PENDING, "probability" => 10]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Proposal & Quote Sent', 'order' => 3, 'color' => '#006060', 'id_pipeline' => 1, "set_result" => Deal::RESULT_PENDING , "probability" => 30]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Negotiation & Adjustments', 'order' => 4, 'color' => '#006060', 'id_pipeline' => 1, "set_result" => Deal::RESULT_PENDING , "probability" => 50]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Decision-Making Phase', 'order' => 5, 'color' => '#006060', 'id_pipeline' => 1, "set_result" => Deal::RESULT_PENDING , "probability" => 70]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Contract Sent', 'order' => 6, 'color' => '#002080', 'id_pipeline' => 1, "set_result" => Deal::RESULT_PENDING , "probability" => 85]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Closed WON', 'order' => 6, 'color' => '#008000', 'id_pipeline' => 1, "set_result" => Deal::RESULT_WON , "probability" => 100]);
    $mPipelineStep->record->recordCreate([ 'name' => 'Closed LOST', 'order' => 4, 'color' => '#f50c0c', 'id_pipeline' => 1, "set_result" => Deal::RESULT_LOST , "probability" => 0]);
