...
class Loader extends \HubletoMain\Core\App
{
  ...
  public function init(): void
  {
    ...
    $this->main->router->httpGet([
      '/^worksheets\/?$/' => Controllers\Dashboard::class,
      '/^worksheets\/contacts\/?$/' => Controllers\Contacts::class,
      '/^settings\/worksheets\/?$/' => Controllers\Settings::class,
    ]);

    // Add placeholder for custom settings.
    // This will be displayed in the Settings app, under the "All settings" card.
    $this->main->apps->community('Settings')->addSetting($this, [
      'title' => 'Worksheets', // or $this->translate('Worksheets')
      'icon' => 'fas fa-table',
      'url' => 'settings/worksheets',
    ]);

    // Add placeholder for your app's calendar.
    $calendarManager = $this->main->apps->community('Calendar')->calendarManager;
    $calendarManager->addCalendar(
      'Worksheets-calendar', // UID of your app's calendar. Will be referenced as "source" when fetching app's events.
    ...
    // $appMenu->addItem($this, 'worksheets/item-1', $this->translate('Item 1'), 'fas fa-table');
    // $appMenu->addItem($this, 'worksheets/item-2', $this->translate('Item 2'), 'fas fa-list');
  }
