    ...
    if (this.props.folder == 'inbox') {
      if (R.read) {
        return <button
          ...
          onClick={(e) => {
            e.preventDefault();
            request.get( "messages/api/mark-as-unread", { idMessage: data.id }, (response: any) => { this.loadData(); } )
          }}
        >
        ...
        return <button
          ...
          onClick={(e) => {
            e.preventDefault();
            request.get( "messages/api/mark-as-read", { idMessage: data.id }, (response: any) => { this.loadData(); } )
          }}
        >
