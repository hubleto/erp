...
| migrate [appNamespace] [model]           | Runs all pending migrations                                                      |
|                                          |                                                                                  |
...
| create migration <appNamespace> <model>  | Creates default migration(s) based on the definitions of the specified model(s). |
