...
class Loader extends \Hubleto\Framework\App
{
  ...
  public function installTables(int $round): void
  {
    if ($round == 1) {
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Deal stage", "group" => "deals" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Project phase", "group" => "projects" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Task status", "group" => "tasks" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Order stage", "group" => "orders" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Lead level", "group" => "leads" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Campaign phase", "group" => "campaigns" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Invoice state", "group" => "invoices" ])['id'];
