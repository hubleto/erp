...
class Model extends \Hubleto\Framework\Model
{
  ...
  const COLUMN_EMAIL_DEFAULT_ICON = 'fas fa-envelope bg-sky-50 rounded text-sky-600 p-2 mr-2 w-10 text-center block';
  const COLUMN_PHONE_DEFAULT_ICON = 'fas fa-phone bg-sky-50 rounded text-sky-600 p-2 mr-2 w-10 text-center block';
