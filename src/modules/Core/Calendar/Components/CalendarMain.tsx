    ...
    return (
      <Calendar
        ...
        onDateClick={(date, time, info) => {
          alert('Zobrazit formular na vyber a) customera, b) leadu alebo c) dealu. Ak si jedno z toho zvoli, otvori sa prislusny form. Ak si nezvoli nic, otvori sa form, ktory bude ukladat do noveho modelu Core/Calendar/Models/Activity');
        }}
        onEventClick={(info) => {
