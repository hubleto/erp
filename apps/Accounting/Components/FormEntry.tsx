...
export default class FormEntry<P, S> extends HubletoForm<FormEntryProps, FormEntryState> {
  ...
  translationContext: string = 'Hubleto\\App\\Community\\Accounting\\Loader::Components\\FormEntry';
    ...
    return <>
      ...
      { R.id > 0 &&
        ...
        <div className="card mt-4">
          <div className="card-body">
            <Table model="Hubleto/App/Community/Accounting/Models/EntryLine" formProps={{
              model: 'Hubleto/App/Community/Accounting/Models/EntryLine',
