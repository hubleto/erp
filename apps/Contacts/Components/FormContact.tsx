          ...
          <div className="w-3/4">
            <div className="flex gap-2 w-full">
              ...
              <div className="w-full">
                ...
                {this.inputWrapper('title_before', {cssClass: 'text-2xl'})}
                {this.inputWrapper('first_name', {cssClass: 'text-2xl'})}
                {this.inputWrapper('middle_name', {cssClass: 'text-2xl'})}
                {this.inputWrapper('last_name', {cssClass: 'text-2xl'})}
