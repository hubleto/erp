...
class Order extends \Hubleto\Erp\Model
{
  ...
  public function describeColumns(): array
  {
    return array_merge(parent::describeColumns(), [
      ...
      'date_next_invoice_expected' => (new Date($this, $this->translate('Next invoice expected on'))),
        ...
        <div class="dmain">
          <div class="dcolumn">
            <div class="content">
              <div>
                ...
                <br/>
                {% if user.DEFAULT_COMPANY.company_id %} IČO: {{ user.DEFAULT_COMPANY.company_id }}<br/> {% endif %}
          ...
          <div class="dcolumn">
            <div class="content odberatel">
              ...
              <br/>
              {% if CUSTOMER.company_id %} IČO: {{ CUSTOMER.company_id }}<br/> {% endif %}
