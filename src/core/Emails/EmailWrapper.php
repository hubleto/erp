...
class EmailWrapper
{
  ...
  public function sendResetPasswordEmail(String $login, String $name, String $language, String $token): void
  {
    ...
    <p style="text-align: center;">
      <a href="'. $this->main->config->getAsString('appUrl') .'/reset-password?token='. $token .'" class="btn--theme">Reset password</a>
    </p>
  ...
  public function sendWelcomeEmail(String $login, String $name, String $language, String $token): void
  {
    ...
    <br>
    <p style="text-align: center;">
      <a href="'. $this->main->config->getAsString('appUrl') .'/reset-password?token='. $token .'" class="btn--theme">Get started</a>
    </p>
    <br>
