...
export default class FormTransaction<P, S> extends HubletoForm<FormTransactionProps, FormTransactionState> {
  ...
  translationContext: string = 'Hubleto\\App\\Community\\BkTransactions\\Loader::Components\\FormTransaction';
    ...
    return <>
      ...
      { R.id > 0 &&
        ...
        <div className="card mt-4">
          <div className="card-body">
            <Table model="Hubleto/App/Community/BkTransactions/Models/Reconciliation" formProps={{
              model: 'Hubleto/App/Community/BkTransactions/Models/Reconciliation',
