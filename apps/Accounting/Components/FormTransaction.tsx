...
export default class FormTransaction<P, S> extends HubletoForm<FormTransactionProps, FormTransactionState> {
  static defaultProps: any = {
    ...
    model: "Hubleto/App/Community/Accounting/Models/Transaction"
  };
  ...
  translationContext: string = 'Hubleto\\App\\Community\\Accounting\\Loader::Components\\FormTransaction';
    ...
    return <>
      ...
      { R.id > 0 &&
        ...
        <div className="card mt-4">
          <div className="card-body">
            <Table model="Hubleto/App/Community/Accounting/Models/Reconciliation" formProps={{
              model: 'Hubleto/App/Community/Accounting/Models/Reconciliation',
