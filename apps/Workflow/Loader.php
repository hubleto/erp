...
class Loader extends \Hubleto\Framework\App
{
  ...
  public function installTables(int $round): void
  {
    if ($round == 1) {
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Campaign phase", "order" => 1, "group" => "campaigns" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Lead level", "order" => 2, "group" => "leads" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Deal stage", "order" => 3, "group" => "deals" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Order stage", "order" => 4, "group" => "orders" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Project phase", "order" => 5, "group" => "projects" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Task status", "order" => 6, "group" => "tasks" ])['id'];
      ...
      $idWorkflow = $mWorkflow->record->recordCreate([ "name" => "Invoice state", "order" => 7, "group" => "invoices" ])['id'];
